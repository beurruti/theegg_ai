# -*- coding: utf-8 -*-
"""
Created on Tue Aug 18 08:15:27 2020

@author: Beñat Urrutikoetxea Arrieta
"""
...
while seguir=="Si":
    try: 
        decimal = Decimal(input("Introduce un número entre 0 y 0.9999 con un maximo de 4 digitos decimales (si marcas 1, sales del programa): "))
        numerador = int(Decimal(decimal) * 100000)
        denominador = 100000
        i = numerador
